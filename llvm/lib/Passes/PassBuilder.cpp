...
//Obfuscate String
static cl::opt<bool> XYTStringObfus("xytsobf", cl::init(false),
...
//Build Obfuscation
ModulePassManager
PassBuilder::buildObfuscationPipeline(OptimizationLevel Level) {
  ...
  //Obfuscate String
  if(XYTStringObfus) {
    MPM.addPass(StringObfuscatePass());
  }
...
PassBuilder::buildPerModuleDefaultPipeline(OptimizationLevel Level,
  ...
  //Obfuscation
  MPM.addPass(buildObfuscationPipeline(Level));
